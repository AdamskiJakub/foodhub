...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[500px] bg-gradient-to-br from-purple-50 via-white to-blue-50 flex items-center justify-center overflow-hidden">
      <div className="absolute top-10 -left-20 w-96 h-96 bg-gradient-primary opacity-10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-10 -right-20 w-[500px] h-[500px] bg-gradient-food opacity-10 rounded-full blur-3xl"></div>
      <div className="absolute top-1/2 left-1/4 w-64 h-64 bg-gradient-success opacity-5 rounded-full blur-3xl"></div>
